			...
			<div class="footer-top">
				<div class="container">
					<div class="row">
						<div class="col-md-3 col-sm-12">
							<div class="footer-info-card">
								<div class="footer-logo">
									<a href="{{ route('home') }}"><img src="{{asset('img/logo-HK.png')}}" alt="logo"></a>
								</div>
							</div>
						</div>
						<div class="col-md-3 col-sm-6">
							<div class="footer-menu-area">
								...
								<div class="footer-menu opening-time">
									<ul>
										<li>{{!empty($info)? $info->open_time:'Chưa có thông tin'}}</li>
									</ul>
								</div>
							</div>
						</div>
						<div class="col-md-3 col-sm-6">
							<div class="footer-menu-area">
								<h2 class="footer-heading">Thông tin cửa hàng</h2>
								<div class="footer-menu">
									<ul>
										<li><a href="{{ route('about') }}"><i class="fa fa-angle-right"></i>Giới thiệu</a></li>
										<li><a href="{{ route('contact') }}"><i class="fa fa-angle-right"></i>Liên hệ</a></li>
									</ul>
								</div>
							</div>
						</div>
						<div class="col-md-3 col-sm-6">
							<div class="contact-info-area">
								...
								<div class="contact-info">
									<div class="contanct-details" style="display: flex; align-items: center;">
										<div class="info-icon">
											<i class="fa fa-phone"></i>
										</div>
										<div class="info-content">
											<p>{{!empty($info)? $info->phone_number:'Chưa có thông tin'}}</p>
										</div>
									</div>
									<div class="contanct-details" style="display: flex; align-items: center;">
										<div class="info-icon">
										...
										<div class="info-content">
											<p>{{!empty($info)? $info->email:'Chưa có thông tin'}}</p>
										</div>
									</div>
									<div class="contanct-details" style="display: flex; align-items: center;">
										<div class="info-icon">
										...
										<div class="info-content">
											<p>{{!empty($info)? $info->address:'Chưa có thông tin'}}</p>
										</div>
									</div>
									<div class="contanct-details" style="display: flex; align-items: center;">
										<div class="info-icon">
											<a class="btn btn-primary" style="color: white" href="{{!empty($info)? $info->facebook:'#'}}"><i class="fa fa-facebook"></i>acebook</a>
										</div>
									</div>
								</div>
							</div>
